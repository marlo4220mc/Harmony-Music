      ...
      child: Column(
        ...
        children: [
                        ...
                        child: Material(
                          ...
                          child: ListTile(
                            onTap: () {
                              launchUrl(
                                Uri.parse(
                                  'https://github.com/marlo4220mc/Harmony-Music/releases/latest',
                                ),
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () {
                      launchUrl(
                        Uri.parse(
                          'https://github.com/marlo4220mc/Harmony-Music',
                        ),
                        mode: LaunchMode.externalApplication,
                      );
                    },
          ...
          Padding(
            ...
            child: Text(
              "${settingsController.currentVersion} ${"by".tr} anandnet | ${"extendedSupport".tr} marlo4220mc",
